...
async def read2d_root(request: Request):
    return templates.TemplateResponse("index_2d.html", {"request": request})
...
async def slice_data(
    ...
    Args:
        ...
        output_grid_mapping (str): The grid mapping type (latitude_longitude or transverse_mercator).
    ...
    try:
        grid_mapping_name = meta.get("grid_mapping_name", "latitude_longitude")
